          ...
          <ul className="list-none mb-6 space-y-6">
            <li className="flex items-start group">
              <Link href="/corporation" className="flex items-start">
                <FaBuilding className="text-blue-900 w-8 h-8 mr-4 group-hover:text-blue-700 transition-colors duration-300" />
                <span className="flex flex-col">
                  <strong className="text-lg font-semibold group-hover:text-blue-900 transition-colors duration-300">
                    법인서비스
                  </strong>
            ...
            <li className="flex items-start group">
              <Link href="/support" className="flex items-start">
                <FaTruck className="text-pink-400 w-8 h-8 mr-4 group-hover:text-pink-300 transition-colors duration-300" />
                <span className="flex flex-col">
                  <strong className="text-lg font-semibold group-hover:text-pink-400 transition-colors duration-300">
                    지원서비스
                  </strong>
                  <span className="text-gray-600 group-hover:text-gray-800 transition-colors duration-300">
            ...
            <li className="flex items-start group">
              <Link href="/business-consulting" className="flex items-start">
                <FaGlobe className="text-blue-900 w-8 h-8 mr-4 group-hover:text-blue-700 transition-colors duration-300" />
                <span className="flex flex-col">
                  <strong className="text-lg font-semibold group-hover:text-blue-900 transition-colors duration-300">
                    비즈니스컨설팅
                  </strong>
            ...
            <li className="flex items-start group">
              <Link href="/corporation-consulting" className="flex items-start">
                <FaChartLine className="text-pink-400 w-8 h-8 mr-4 group-hover:text-pink-300 transition-colors duration-300" />
                <span className="flex flex-col">
                  <strong className="text-lg font-semibold group-hover:text-pink-400 transition-colors duration-300">
                    상장컨설팅
                  </strong>
