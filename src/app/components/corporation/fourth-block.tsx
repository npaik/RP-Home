  ...
  return (
    <div className="bg-orange-600 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
        ...
        <Link href="/contact">
          <div className="mt-4 md:mt-0 bg-transparent hover:bg-white text-white hover:text-orange-600 py-2 px-6 rounded-md border border-white flex items-center space-x-2 cursor-pointer">
