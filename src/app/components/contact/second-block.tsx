    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="flex flex-col md:flex-row justify-between items-start">
        <div className="md:w-1/2 pr-8">
          <h2 className="text-lg font-semibold text-rpBlue mb-4">Contact Us</h2>
          ...
          <ul className="space-y-6">
            <li className="flex items-center">
              <FaMapMarkerAlt className="text-rpBlue w-6 h-6" />
        ...
        <div className="md:w-1/2 bg-gray-100 p-8 rounded-lg shadow-md mt-8 md:mt-0">
          <form onSubmit={handleSubmit}>
            ...
            <div className="text-right">
              <button
                type="submit"
                className="px-4 py-2 bg-rpBlue text-white rounded-lg hover:bg-rpOrange focus:outline-none focus:shadow-outline"
              >
                Send Message
              </button>
            </div>
